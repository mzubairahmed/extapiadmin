...
/*    @JsonProperty("ProductBreakoutBy")
    ...
    @JsonProperty("ProductBreakoutByOptionName")
    private String                productBreakoutByOptionName;
    public String getProductBreakoutByOptionName() {
        return productBreakoutByOptionName;
    }

    public void setProductBreakoutByOptionName(String productBreakoutByOptionName) {
        this.productBreakoutByOptionName = productBreakoutByOptionName;
    }*/
    @JsonProperty("ProductBreakoutBy")
